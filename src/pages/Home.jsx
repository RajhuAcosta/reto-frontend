    ...
    <main className="min-h-screen font-[Lato] lg:grid lg:grid-cols-[380px_auto]">
      ...
      <section className="min-h-screen bg-[#e2f2ff] px-3 py-8 lg:px-20 lg:py-12 relative">
        <form
          ...
          className="mx-auto w-[240px] md:w-[600px] 1.5xl:w-[900px] h-16 shadow-md rounded-full bg-white grid lg:grid-cols-[auto_150px] items-center pl-7 lg:pl-10 pr-2.5 "
        >
